  ...
  if (!election) {
    return (
      <div className="flex flex-col items-center justify-center h-64 text-gray-600">
        ...
        <p className="text-lg text-center px-4">The election you are looking for does not exist or has been removed.</p>
      </div>
    );
  }
      ...
      <div className="space-y-6 mb-8 text-gray-800">
        <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-200">
          ...
          <div>
            ...
            <p className="text-md leading-relaxed">{election.description}</p>
          </div>
        </div>
